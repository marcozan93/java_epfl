...
public final class Main {
    public static void main(String[] args) {
        ...
        // votre avancement.
        Image<ColorRGB> disk = RedDisk.IMAGE;
        Image<ColorRGB> board = new Rotated<>(Chessboard.IMAGE, 10);
        Image<ColorRGB> image = new Composed(disk, board, HorizontalGradientMask.IMAGE);
    ...
    private static final class ImageComponent extends JComponent {
        private final cs108.Lesson2.Image<ColorRGB> image;
